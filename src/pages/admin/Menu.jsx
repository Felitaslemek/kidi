    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-4">
      <header className="w-full flex justify-between items-center bg-white shadow p-4 rounded-lg max-w-6xl">
        ...
        <nav className="flex gap-4 text-gray-600">
          ...
          <a href="#" className="hover:text-blue-600 text-blue-600">Menu</a>
        </nav>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white shadow rounded-lg p-6 flex flex-col justify-between">
            <div className="text-center">
              <h2 className="text-lg font-semibold text-gray-700 mb-4">Total Menu</h2>
              <p className="text-4xl font-bold text-blue-600 mb-4">4</p>
            </div>
          ...
          <div className="bg-white shadow rounded-lg p-6 flex flex-col justify-between">
            <div className="text-center">
              <h2 className="text-lg font-semibold text-gray-700 mb-4">Menu Baru</h2>
              <p className="text-4xl font-bold text-blue-600 mb-4">&nbsp;</p>
            </div>
            <button className="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 transition-colors">
              Tambah
            </button>
