  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-4 md:p-8">
        <button onClick={handleBack} className="text-gray-500 hover:text-gray-700 mb-6 self-start">
          <ArrowLeftIcon className="h-5 w-5" />
        </button>

        <div className="flex-1 flex flex-col justify-start max-w-md w-full">
          <h1 className="text-[#2563EB] text-3xl md:text-4xl font-semibold mb-4 md:mb-8 text-center">Buat Akun</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
            <div>
              <label className="font-semibold block text-sm text-gray-600 mb-1">Nama Anda</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="font-semibold block text-sm text-gray-600 mb-1">Email Anda</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="font-semibold block text-sm text-gray-600 mb-1">Password</label>
