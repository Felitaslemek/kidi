...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      <nav className="flex items-center justify-between p-4 border-b relative rounded-lg bg-white shadow-md mx-4 my-2">
      ...
      <div id="location" className="bg-blue-600 text-white py-6 px-6 flex flex-col md:flex-row items-center justify-between mx-4 md:mx-10 my-10 rounded-lg gap-4">
        <div className="flex items-center gap-4">
          <div className="bg-white/20 p-2 rounded-lg">
            <img src={logok} alt="Logok" className="w-12 h-12" />
          </div>
          <div>
